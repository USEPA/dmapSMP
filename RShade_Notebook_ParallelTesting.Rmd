...
```{r}
RShade_points <- extract_horizon_angle_parallel(RShade_points, rpu_boundaries)
```
...
```{r}
RShade_points <- star_sample_parallel(RShade_points, veg_cover, star_sample_angles, star_sample_distances, output_type="cvr")
```

```{r}
RShade_points <- star_sample_parallel(RShade_points, veg_height, star_sample_angles, star_sample_distances, output_type="hght")
```
