...
```{r}
RShade_points <- extract_horizon_angle(shade_points, rpu_boundaries)
```
...
This is a test for parallelization of the star_sample function. 

```{r}
RShade_points <- star_sample_parallel(RShade_points, veg_cover, star_sample_angles, star_sample_distances, type="hght")
```
